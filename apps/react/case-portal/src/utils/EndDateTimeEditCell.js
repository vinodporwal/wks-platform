...
export const EndDateTimeEditCell = ({ id, field, value, api }) => {
  const row = api.getRow(id)
  const startDate = row?.maintStartDateTime
    ? dayjs(row.maintStartDateTime)
    : null
  ...
  return (
    <LocalizationProvider dateAdapter={AdapterDayjs}>
      <DateTimePicker
        ...
        minDateTime={startDate ?? financialYearStart}
...
export default EndDateTimeEditCell
