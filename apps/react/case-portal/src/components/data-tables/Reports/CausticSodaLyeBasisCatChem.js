...
const CausticSodaLyeBasisCatChem = () => {
  ...
  const EXCEL_NAME = `${VERTICAL_NAME_U}_${SITE_NAME_U}_${PLANT_NAME_U}_Cat_Chem_${AOP_YEAR}`
...
export default CausticSodaLyeBasisCatChem
