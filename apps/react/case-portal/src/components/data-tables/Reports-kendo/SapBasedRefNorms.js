...
const SapBasedRefNorms = () => {
  const keycloak = useSession()
  const REPORT_TYPE_FOR_ALL = 'SapBasedRefNorms'
  ...
  const fileName = `${VERTICAL_NAME}-Production Target Basis.xlsx`
...
export default SapBasedRefNorms
