...
import { ShutdownConsumptionApiService } from 'components/aop-phase-two/services/common/shutdownConsumptionApiService'

const ShutdownConsumptionGrid = () => {
...
export default ShutdownConsumptionGrid
