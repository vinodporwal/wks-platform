...
async function exportConfigurationExcel(keycloak, plantId, year) {
  return ImportExportApiService.exportExcelData(keycloak, {
    ...
    queryParams: {},
    fileName: `ALKYLATION_Production_Norms_Configuration_${year}.xlsx`,
    method: 'GET',
  })
}
...
async function exportPIMSThroughputExcel(keycloak, plantId, year) {
  return ImportExportApiService.exportExcelData(keycloak, {
    ...
    queryParams: {},
    fileName: `ALKYLATION_Production_Norms_PIMS_Throughput_${year}.xlsx`,
    method: 'GET',
  })
}
...
async function exportConstantsExcel(keycloak, plantId, year, excelName) {
  return ImportExportApiService.exportExcelData(keycloak, {
    endpoint: `vgoht/norms-basis/constant/export/${plantId}/${year}`,
    queryParams: {},
    fileName: excelName || `ALKYLATION_Production_Norms_Constants_${year}.xlsx`,
    method: 'GET',
  })
}
...
async function exportManualEntryExcel(keycloak, plantId, year) {
  return ImportExportApiService.exportExcelData(keycloak, {
    ...
    fileName: `ALKYLATION_Production_Norms_Manual_Entry_${year}.xlsx`,
    method: 'POST',
  })
}
