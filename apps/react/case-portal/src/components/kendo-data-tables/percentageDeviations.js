...
const percentageDeviations = ({ viewOnly, permissions }) => {
  ...
  const EXCEL_NAME = `${VERTICAL_NAME_UPPERCASE}_${SITE_NAME_UPPERCASE}_${PLANT_NAME_UPPERCASE}_Percentage_Deviation_${AOP_YEAR}`
  ...
  const dataConfig = useMemo(
    () => ({
      serviceFn: () =>
        MaintenanceDetailsApiService.getPercentageDeviation(
          keycloak,
          PLANT_ID,
          AOP_YEAR,
        ),
...
export default percentageDeviations
