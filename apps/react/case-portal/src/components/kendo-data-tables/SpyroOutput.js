...
const SpyroOutput = () => {
  // Cracker’s own tabs
  const rawTabs = ['total feed', 'total products', 'miscellaneous parameters']
              ...
              return (
                <Box>
                  <SelectivityData
                    rows={feedRowsDummy}
                    setRows={setFeedRows}
                    fetchData={() => fetchCrackerRows('total feed')}
                    configType='cracker'
                  />
                </Box>
              )
              ...
              return (
                <Box>
                  <SelectivityData
                    ...
                    fetchData={() => fetchCrackerRows('total products')}
                    configType='cracker'
                  />
                </Box>
              )
