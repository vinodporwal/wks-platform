...
const SeasonMonthsGrid = ({ summary, summaryEdited, setSummaryEdited }) => {
  ...
  const fetchData = async () => {
    ...
    try {
      setLoading(true)
      const response = await DataService.getSeasonMonth(
        keycloak,
        PLANT_ID,
        AOP_YEAR,
      )
...
export default SeasonMonthsGrid
