...
export default function ConversionVariableCost() {
     ...
     const mcuCapacityUtilizationColumns = [
          ...
          { field: 'plantName', title: 'Plant', widthT: 30, editable: false, locked: true, },
          { field: 'costType', title: 'Cost Head', widthT: 30, editable: false, locked: true, },
          {
               field: 'previousAop',
               title: `FY${prev} AOP`,
               editable: false,
     ...
     const saveChanges = React.useCallback(async () => {
          try {
               ...
               const payload = data.map(({ id, plantName, costType, previousAop, previousActual, currentAop, remark, siteFkId, aopYear }) => ({
                    id: id || null,
                    plantName,
                    costType,
                    previousAop,
     ...
     const adjustedPermissions = getAdjustedPermissions(
          {
               ...
               titleName: 'Conversion Variable Cost',
