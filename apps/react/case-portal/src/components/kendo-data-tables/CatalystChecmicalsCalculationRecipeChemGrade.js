...
const CatalystChecmicalsCalculationRecipeChemGrade = ({
  permissions,
  onSaveOrImport,
  refreshTrigger,
}) => {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      const res =
        await CatChemRecipeChemGradeApiService.getCatChemChemGradeData(
          keycloak,
          PLANT_ID,
          AOP_YEAR,
        )
  ...
  const saveChanges = React.useCallback(async () => {
    try {
      ...
      const response =
        await CatChemRecipeChemGradeApiService.saveCatChemChemGradeData(
          keycloak,
          PLANT_ID,
          AOP_YEAR,
          payload,
  ...
  const handleExcelUpload = async (file) => {
    ...
    try {
      const response =
        await CatChemRecipeChemGradeApiService.importCatChemChemGradeExcel(
          file,
          keycloak,
          PLANT_ID,
          AOP_YEAR,
