...
const ProductionScheduling = ({ permissions }) => {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      const res =
        await ProductionSchedulingApiService.getProductionSchedulingData(
          keycloak,
          PLANT_ID,
          AOP_YEAR,
        )
  ...
  const fetchDataTransaction = useCallback(async () => {
    ...
    try {
      const res =
        await ProductionSchedulingApiService.getProductionSchedulingTransactionData(
          keycloak,
          PLANT_ID,
          AOP_YEAR,
        )
  ...
  const saveChanges = React.useCallback(async () => {
    try {
      ...
      const response =
        await ProductionSchedulingApiService.updateProductionSchedulingData(
          PLANT_ID,
          payload,
          keycloak,
          AOP_YEAR,
