      ...
      const saveChanges = React.useCallback(async () => {
           try {
                ...
                payload = data.map((item) => ({
                     ...
                     dmWaterCalcSodiBiCarbId: item.dmWaterCalcSodiBiCarbId || null,
                     dmWaterCalcPolystatId: item.dmWaterCalcPolystatId || null,
                     dmWaterCalcEvicasId: item.dmWaterCalcEvicasId || null,
                     dmWaterCalcPva88Id: item.dmWaterCalcPva88Id || null,
                     dmWaterCalcPva55Id: item.dmWaterCalcPva55Id || null,
                     dmWaterCalcB72Id: item.dmWaterCalcB72Id || null,
                     dmWaterCalcL9pId: item.dmWaterCalcL9pId || null,
                     dmWaterCalcVerseneId: item.dmWaterCalcVerseneId || null,
                     dmWaterCalcNonylPheId: item.dmWaterCalcNonylPheId || null,
                     dmWaterCalcIrgastabId: item.dmWaterCalcIrgastabId || null,
                     dmWaterCalcAtscId: item.dmWaterCalcAtscId || null,
                     dmWaterCalcAntiswellingId: item.dmWaterCalcAntiswellingId || null,
                     dmWaterCalcAntifoamId: item.dmWaterCalcAntifoamId || null,
                     dmWaterCalcK57CatalystId: item.dmWaterCalcK57CatalystId || null,
                     dmWaterCalcK67CatalystId: item.dmWaterCalcK67CatalystId || null,
                }))
