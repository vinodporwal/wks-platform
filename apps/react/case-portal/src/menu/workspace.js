    ...
    // },
    {
      ...
      children: [
        ...
        },
        {
          icon: 'IconReport',
          id: 'qty-cost-report',
          title: 'menu.norms_qty_cost_report',
          type: 'item',
          url: '/utilityPlant/qty-cost-report',
          breadcrumbs: true,
        },
        {
          icon: 'IconReport',
          id: 'utility-rate',
          title: 'menu.utility_rate',
          type: 'item',
          url: '/utilityPlant/utility-rate',
          breadcrumbs: true,
        },
        {
          icon: 'IconReport',
        ...
        },
        {
          ...
          title: 'menu.senderReceiverMapping',
          type: 'item',
