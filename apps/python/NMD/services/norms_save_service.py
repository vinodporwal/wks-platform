...
def _sync_to_cpp_norms(conn, norms_header_fk_id: str, fym_id: str, norms_value: float, modified_by: str = 'NMDModel') -> bool:
    """
    ...
    Args:
        ...
        modified_by: Who modified the norms (default: 'NMDModel')
...
def save_calculated_norms(
    ...
    for row in sorted_existing:
        ...
        # a generation quantity for this (plant, utility) pair.
        # This is more reliable than checking account_name, because material
        # rows of a generating utility may have different account names
        # (e.g. "Raw Material", "Catalyst & Chemical", "By Product", etc.)
        # but they all share the same generation QTY.
