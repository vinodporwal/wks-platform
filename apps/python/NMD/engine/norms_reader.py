...
class NMDNormsReader:
    ...
    def _build_indexes(self):
        ...
        for row in self._rows:
            ...
            # Track U4U materials (Utilities + Catalyst & Chemical + Raw Material accounts)
            # These are consumed by generation utilities but not generated by NMD plant
            if account in ("Utilities", "Catalyst & Chemical", "Raw Material"):
    ...
    def get_consumption_norms_flat(self) -> Dict[str, Dict[str, float]]:
        ...
        Includes Utilities, Catalyst & Chemical, and Raw Material account entries (U4U norms).
        """
