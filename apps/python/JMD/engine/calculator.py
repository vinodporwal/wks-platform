...
# ---------------------------------------------------------------------------
# External import power defaults (MWh/month) per plant
# These represent power received from external interconnects (e.g. DTA-C2 bus)
# that is NOT generated by the plant's own GT/STG assets.
# Override by passing external_import_mwh to calculate_for_plant().
# ---------------------------------------------------------------------------
_EXTERNAL_IMPORT_MWH_DEFAULTS: dict = {
    "BA558F95-8A3F-4769-9C78-FF7B6C639DDF": 8603.54,   # C2-CPP: DTA-C2 Power & UTILITY interconnect
...
def run_month(plant_id: str, month: int, year: int, save_to_db: bool = True) -> dict:
    ...
    try:
        ext_import = _EXTERNAL_IMPORT_MWH_DEFAULTS.get(plant_id.upper(), 0.0)
