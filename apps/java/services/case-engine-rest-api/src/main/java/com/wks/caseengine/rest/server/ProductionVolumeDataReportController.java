...
public class ProductionVolumeDataReportController {
	...
	@DeleteMapping(value="/report/plant/production/plan")
	public AOPMessageVM deletePlantProductionPlanData(@RequestParam String id) {
		return productionVolumeDataReportService.deletePlantProductionPlanData(id);
	}
