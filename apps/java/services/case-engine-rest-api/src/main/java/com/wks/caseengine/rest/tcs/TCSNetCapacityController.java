...
public class TCSNetCapacityController {
    ...
    {
        log.info("Received request to getAllTCSNetCapacity - plantId: {}, year: {}, capacityType: {}, siteId: {}, verticalId: {}",
        ...
        try {
            ...
            log.info("Successfully retrieved TCS Net Capacity data - Response keys: {}", response.keySet());
            log.debug("Response: {}", response);
            
            return response;
        } catch (Exception e) {
            log.error("Error occurred while fetching TCS Net Capacity data", e);
            throw e;
        }
    }
}
