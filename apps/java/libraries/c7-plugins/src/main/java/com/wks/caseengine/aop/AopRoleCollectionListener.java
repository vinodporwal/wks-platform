 ...
 * {@code ${delegateExpression}} beans are not reachable from the engine.
 * Canonical source lives in {@code case-engine}; this copy is kept in sync for
 * the engine classpath ({@code c7-plugins} userlib).</p>
 */
