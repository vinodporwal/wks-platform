...
public class BusinessDemandDataServiceImpl implements BusinessDemandDataService {
	...
	public List<BusinessDemandDataDTO> getBusinessDemandData(String year, String plantId) {
		...
		// List<Object[]> list =
		// businessDemandDataRepository.getAllBusinessDemandData(plantId);
		// int i=1;
		// for(Object[] obj1 :list){
		// System.out.println("obj1"+obj1);
		// BusinessDemandDataDTO businessDemandDataDTO = new BusinessDemandDataDTO();

		// businessDemandDataDTO.setNormParameterId(obj1[0]!=null?
		// obj1[0].toString():null);
		// businessDemandDataDTO.setNormParameterTypeDisplayName(obj1[1]!=null?
		// obj1[1].toString():null);
