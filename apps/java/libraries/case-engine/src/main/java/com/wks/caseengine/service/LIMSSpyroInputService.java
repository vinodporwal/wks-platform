...
public interface LIMSSpyroInputService {
    ...
    AOPMessageVM getLIMSSpyroInput(String plantId, String aopYear, String startDate, String endDate);
    AOPMessageVM saveLIMSSpyroInput(String year, String plantFKId, List<LIMSSpyroInputDTO> lIMSSpyroInputDTOs);
    byte[] exportLIMSSpyroInput(String year, String plantFKId, String startDate, String endDate, boolean isAfterSave, List<LIMSSpyroInputDTO> dtoList);
