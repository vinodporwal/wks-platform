...
import com.wks.caseengine.tcs.entity.TCSNetCapacity;
import com.wks.caseengine.tcs.repository.TCSNetCapacityRepository;
...
public class TCSNetCapacityServiceImpl implements TCSNetCapacityService {
    ...
    @Autowired
    private TCSNetCapacityRepository tcsNetCapacityRepository;
...
//final Plants plant = null;
    ...
    vertical = verticalRepository
        ...
        //    }
            ...
            for (Field field : TCSTestCapacityDTO.class.getDeclaredFields()) {
    ...
    public AOPMessageVM saveOrUpdate(
       ...
       // String uom,
        ...
        try {
            List<TCSNetCapacity> savedList = new ArrayList<>();
            for (TCSNetCapacityDTO dto : dtoList) {                
                ...
                TCSNetCapacity entity = new TCSNetCapacity();
            ...
            //    entity.setUom(dto.getUom());
                ...
                tcsNetCapacityRepository.save(entity);
    ...
    private TCSNetCapacityDTO toDTO(TCSNetCapacity entity) {
        return TCSNetCapacityDTO.builder()
        ...
        String capacityType,
          String verticalId) {
           ...
           vertical = verticalRepository
            ...
            try {
                List<TCSNetCapacityUOMDTO> results = getAllUOMData(
                    vertical.getName().toUpperCase(),
                    plantId,
                    aopYear,
                    capacityType);
    ...
    // private List<TCSNetCapacityUOMDTO> getAllUOMData(
    //     String verticalName,
    //     String plantId,
    //     String aopYear,
    //     String capacityType) {
