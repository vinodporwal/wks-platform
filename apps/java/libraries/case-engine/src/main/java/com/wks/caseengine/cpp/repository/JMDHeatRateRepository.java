...
public interface JMDHeatRateRepository extends JpaRepository<DummyEntity, Long> {
    ...
    List<STGHeatRateProjection> findStgHeatRateByFinancialYear(@Param("financialYear") String financialYear, @Param("previousFinancialYear") String previousFinancialYear);
}
