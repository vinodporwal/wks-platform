...
public class AOPMCCalculatedDataServiceImpl implements AOPMCCalculatedDataService {
	...
	public AOPMessageVM getAOPMCCalculatedData(String plantId, String year) {
	    ...
	    try {
	        ...
	        } else if((vertical.getName().equalsIgnoreCase("ELASTOMER") && site.getName().equalsIgnoreCase("JMD")) ||  vertical.getName().equalsIgnoreCase("CHEMICAL") ) {
	...
	public AOPMessageVM getAverageMCValues(String plantId, String year) {
	    ...
	    try {
	        ...
	        Sites site = siteRepository.findById(plant.getSiteFkId())
	                .orElseThrow(() -> new IllegalArgumentException("Invalid site ID"));
	        String procedureName=vertical.getName()+"_"+site.getName()+"_GetAverageMCValues";
	       
	        List<Object[]> 	obj= findByAOPYearAndPlantId(year, UUID.fromString(plantId) ,  procedureName);
	        List<AOPMCCalculatedDataDTO> aOPMCCalculatedDataDTOList = new ArrayList<>();
	...
	public List<Object[]> findByAOPYearAndPlantId(String aopYear, UUID plantId, String procedureName) {
		try {
    ...
    public AOPMessageVM getMaxAchievedCapacity(String plantId, String year) {
        ...
        try {
            ...
            if(vertical.getName().equalsIgnoreCase("CRACKER") || (vertical.getName().equalsIgnoreCase("ELASTOMER") && site.getName().equalsIgnoreCase("JMD")) || vertical.getName().equalsIgnoreCase("CHEMICAL")) {
	        	obj= findByYearAndPlantId(year, UUID.fromString(plantId) ,  procedureName);
	        }else {
