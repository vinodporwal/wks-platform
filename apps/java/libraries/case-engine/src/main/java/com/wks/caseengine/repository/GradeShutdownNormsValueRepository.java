...
public interface GradeShutdownNormsValueRepository extends JpaRepository<GradeShutdownNormsValue,UUID>{
	...
	@NativeQuery("SELECT TOP 1 Id FROM GradeShutdownNormsValue " +
	...
	@NativeQuery("SELECT * FROM dbo.GradeShutdownNormsValue WHERE Plant_FK_Id = :plantId and FinancialYear = :FinancialYear")
