...
public interface HeatRateRepository extends JpaRepository<DummyEntity, Long> {
    ...
    List<com.wks.caseengine.cpp.dto.heatrate.STGHeatRateProjection> findStgHeatRateByAssetIdAndFinancialYear(@Param("assetId") UUID assetId, @Param("financialYear") String financialYear, @Param("previousFinancialYear") String previousFinancialYear);
}
