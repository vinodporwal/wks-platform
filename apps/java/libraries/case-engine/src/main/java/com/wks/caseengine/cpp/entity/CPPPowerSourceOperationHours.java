...
@Entity
@Table(name = "CPPPowerSourceOperationHours", schema = "dbo")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class CPPPowerSourceOperationHours {

    @Id
    @Column(name = "Id", nullable = false, columnDefinition = "uniqueidentifier")
    private UUID id;

    @Column(name = "PowerSource_FK_Id", columnDefinition = "uniqueidentifier")
