...
/****** 
Object:  StoredProcedure [dbo].[CPP_GetCPPNorms]
Description: Updated to include Catalyst & Chemical and Raw Material accounts for 40NF plant
Modified: To support multiple account types (Utilities, Catalyst & Chemical, Raw Material)
******/
...
BEGIN
    ...
    (
        ...
        WHERE nh.IsActive = 1
            -- Updated to include multiple account types for 40NF plant
